...
.brandGlyph{display:inline-grid;place-items:center;width:22px;height:22px;border-radius:6px;background:linear-gradient(135deg,var(--cyan),var(--blue));color:#04101f;font-size:12px;font-weight:900;letter-spacing:0}
