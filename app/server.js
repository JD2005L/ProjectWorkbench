...
import { SCOPES, mintToken, loadTokens, saveTokens, safeTokenShape, resolveToken,
         presentedToken, tokenHasScope, isKnownScope, looksLikeApiToken } from './api-tokens.js';
...
app.post(BASE + '/api/tokens', requireAdmin, async (req,res) => {
 try {
  ...
  await audit('api_token_create', { tokenId:record.id, label, scopes }, req);
